...
class MessageHandlerTest {
    ...
    static class MockDateTimeArg extends DateTimeArg {
        ...
        public MockDateTimeArg(String s) { super(java.time.LocalDate.now(), java.time.LocalTime.now()); this.str = s; }
        @Override public String toString() { return str; }
    }
    static class MockTask extends Task {
        private final String str;
        public MockTask(String name) { super(name); this.str = "[T][ ] " + name; }
        @Override public String toString() { return str; }
        @Override public String toSaveString() { return "MockTask|SaveString"; }
    }
    static class MockTaskList extends TaskList {
        private final List<Task> internalList;
        public MockTaskList(List<Task> tasks) { internalList = tasks; }
        @Override public int getCount() { return internalList.size(); }
        @Override public Task getTask(int index) { return internalList.get(index); }
    }
    static class MockReminder extends Reminder {
        private final String str;
        public MockReminder(String name) { super(name, new MockDateTimeArg(""), Clock.systemDefaultZone()); this.str = name + " (Reminder)"; }
        @Override public String toString() { return str; }
        @Override public String toSaveString() { return "MockReminder|SaveString"; }
    }
    static class MockHabit extends Habit {
        private final String str;
        public MockHabit(String name) { super(name, Duration.ofDays(1), Clock.systemDefaultZone()); this.str = "[H] " + name; }
        @Override public String toString() { return str; }
        @Override public String toSaveString() { return "MockHabit|SaveString"; }
    }
    static class MockHabitList extends HabitList {
        private final List<Habit> internalList;
        public MockHabitList(List<Habit> habits) { super(); internalList = habits; }
        @Override public int getCount() { return internalList.size(); }
        @Override public ArrayList<Habit> getAllHabits() { return new ArrayList<>(internalList); }
    }
    ...
    static class MockReminderList extends ReminderList {
        ...
        @Override public Reminder getReminder(int index) { return reminders.get(index); }
    }
    ...
    private String normaliseOutput(String output) { return output.replaceAll("\\r\\n|\\r", "\n"); }

    // --- sendMessage (varargs logic) ---
    @Test void sendMessage_multipleMessages_success() {
    ...
    // --- Find Results ---
    @Test void sendFindResults_empty_noResults() {
        MessageHandler.sendFindResults(new ArrayList<>());
        String expected = LINE + "No results found!\n" + LINE;
        assertEquals(normaliseOutput(expected), normaliseOutput(outContent.toString()));
    }
    @Test void sendFindResults_nonEmpty_found() {
    ...
    // --- Add/Delete Count (pluralization, branches) ---
    @Test void sendAddTaskMessage_countOne_singular() {
    ...
    @Test void sendAddTaskMessage_countTwo_plural() {
        MessageHandler.sendAddTaskMessage(new MockTask("Task"), 2);
        String expected = LINE + "Got it. I've added this task:\n[T][ ] Task\nNow you have 2 tasks in the task list.\n" + LINE;
        assertEquals(normaliseOutput(expected), normaliseOutput(outContent.toString()));
    }

    @Test void sendDeleteTaskMessage_countMultiple_plural() {
    ...
    @Test void sendDeleteTaskMessage_countOne_singular() {
    ...
    // --- Reminder delete ---
    @Test void sendDeleteReminderMessage_countMultiple_plural() {
    ...
    @Test void sendDeleteReminderMessage_countOne_singular() {
    ...
    @Test void sendEditFromMessage_success() {
    ...
    @Test void sendEditToMessage_success() {
    ...
    @Test void sendAddReminderRecMessage_countOne_singular() {
    ...
    @Test void sendAddReminderRecMessage_countTwo_plural() {
        MessageHandler.sendAddReminderRecMessage(new MockReminder("Rem"), 2);
        String expected = LINE + "Got it. I've added this recurring reminder:\nRem (Reminder)\nNow you have 2 reminders in the reminder list.\n" + LINE;
        assertEquals(normaliseOutput(expected), normaliseOutput(outContent.toString()));
    }
    @Test void sendAddReminderOneTimeMessage_countOne_singular() {
    ...
    @Test void sendAddReminderOneTimeMessage_countTwo_plural() {
    ...
    // --- Reminder notify API ---
    @Test void sendReminder_success() {
    ...
    @Test void sendIsTurnOnReminderMessage_success() {
    ...
    @Test void sendAlreadyTurnOnReminderMessage_success() {
    ...
    @Test void sendIsTurnOffReminderMessage_success() {
    ...
    @Test void sendAlreadyTurnOffReminderMessage_success() {
    ...
    @Test void sendRecUnableToSnoozeError_success() {
    ...
    @Test void sendSnoozeMessage_success() {
    ...
    @Test void sendAddHabitMessage_countOne_singular() {
    ...
    @Test void sendIncStreakMessage_onTime_success() throws StudyMateException {
    ...
    @Test void sendIncStreakMessage_tooEarly_success() throws StudyMateException {
    ...
    @Test void sendIncStreakMessage_tooLate_success() throws StudyMateException {
